...
netcdfFlag=0;  % use csp2nc.m and csp2nc4.m if set.
...
'RAN17G','/nas2/bic/RAN17G','Global',2,9,  2,
...
cspbasedir='/nas5/cyc4out.ran17';  % base directory of csp outputs.
...
%        biaslist={'MODISA','MODIST'};
    ...
    if hiresgridFlag,
      ...
      if 1, % save dt_1km_data (large file):
